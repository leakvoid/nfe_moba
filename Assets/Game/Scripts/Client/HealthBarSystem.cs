...
public partial struct HealthBarSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        foreach (var (transform, healthBarOffset, maxHitPoints, entity)
            in SystemAPI.Query<LocalTransform, HealthBarOffset, MaxHitPoints>().WithNone<HealthBarUIReference>().WithEntityAccess())
        {
        ...
        foreach (var (transform, healthBarOffset, currentHitPoints, maxHitPoints, healthBarUI)
