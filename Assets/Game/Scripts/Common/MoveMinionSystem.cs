...
public partial struct MoveMinionSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        foreach (var (transform, pathPositions, pathIndex, moveSpeed)
            in SystemAPI.Query<RefRW<LocalTransform>, DynamicBuffer<MinionPathPosition>, RefRW<MinionPathIndex>, CharacterMoveSpeed>().WithAll<Simulate>())
        {
